...
namespace Vu_DbFrist.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(DbCompanyManagerDbfirstContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("CompanyId,CompanyName,CompanyDescription,CompanyPhone")] Company company)
        {
